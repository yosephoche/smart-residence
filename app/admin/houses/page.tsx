...
export default function HousesPage() {
  ...
  const handleDeleteConfirm = async () => {
    ...
    if (res.ok) {
      setSuccessMessage(`House "${houseToDelete.houseNumber}" has been deleted successfully`);
      ...
      render: (_, house) => (
        <div>
          ...
          <p className="text-sm text-gray-600">
            {house.houseType && formatCurrency(house.houseType.price)}/month
          </p>
        </div>
      ),
    },
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-success-50 rounded-xl border-2 border-success-200 p-4 shadow-sm">
          <p className="text-sm font-medium text-success-700">Occupied</p>
      ...
      <div className="bg-white rounded-xl border-2 border-gray-200 p-4">
        ...
        <div className="mt-4 pt-4 border-t-2 border-gray-100">
          <span className="text-sm text-gray-600">
            Showing <span className="font-semibold">{filteredHouses.length}</span> of{" "}
      ...
      <ConfirmModal
        ...
        title="Delete House"
        message={`Are you sure you want to delete house "${houseToDelete?.houseNumber}"? This action cannot be undone.`}
        confirmText="Delete"
        variant="danger"
